...
#&GrabDBHash ($UsingDB); # Hash DB before playing with it
...
open(FILE, $file) or die "Couldn't open file: $!\n"; # Open the DB <- This may break once we get an actual connection to the DB, warning
